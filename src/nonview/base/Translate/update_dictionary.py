...
DICTIONARY_PATH = os.path.join(
    "src", "nonview", "base", "Translate", "DICTIONARY.json"
)
DICTIONARY_JS_PATH = os.path.join(
    "src", "nonview", "base", "Translate", "DICTIONARY.js"
)
TRANSLATE_QUEUE_PATH = os.path.join(
    "src", "nonview", "base", "Translate", "translate_queue.txt"
)
...
def filter_phrases(lines):
    ...
    for line in lines:
        ...
        words = [word for word in line.split(" ") if ".js" not in word]
        phrase = " ".join(words)
        phrase = phrase.strip()
...
def get_translator_idx():
    return {
        lang: GoogleTranslator(source="en", target=lang) for lang in get_langs()
    }
